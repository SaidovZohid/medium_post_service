...
func (x *VerifyResponse) GetCreatedAt() string {
	if x != nil {
		return x.CreatedAt
	}
	return ""
...
var file_auth_service_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x22, 0xc8, 0x01, 0x0a, 0x0e, 0x56, 0x65, 0x72, 0x69,
	...
	0x65, 0x6e, 0x32, 0x8d, 0x01, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x79, 0x22, 0x00, 0x12, 0x3d, 0x0a, 0x06, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x12, 0x17, 0x2e,
...
var file_auth_service_proto_goTypes = []interface{}{
	...
	(*VerifyResponse)(nil),  // 2: genproto.VerifyResponse
...
var file_auth_service_proto_depIdxs = []int32{
	...
	2, // 3: genproto.AuthService.Verify:output_type -> genproto.VerifyResponse
